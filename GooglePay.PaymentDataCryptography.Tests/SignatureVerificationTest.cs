...
namespace GooglePay.PaymentDataCryptography.Tests
{
    public class SignatureVerificationTest
    {
        ...
        public void TestVerifyMessage()
        {
            ...
            Assert.True(SignatureVerification.VerifyMessage(payload, "Google", "someRecipient", new GoogleKeyProvider(keyData)));
        }
        ...
        public void TestVerifyMessageECv2()
        {
            ...
            Assert.True(SignatureVerification.VerifyMessage(payload, "Google", "merchant:12345", new GoogleKeyProvider(keyData)));
        }
    }
}
